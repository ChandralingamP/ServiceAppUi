...
export default function AdminProfileScreen({ navigation }) {
    ...
    return (
        ...
        >
            ...
            <ScrollView>
                <MenuBar item={{ menu: "Your Address", screen: "YourAddressScreen" }} navigateTo={navigateTo}></MenuBar>
                <MenuBar item={{ menu: "Logout", screen: "logout" }} navigateTo={navigateTo}></MenuBar>
            </ScrollView>
        </View>
    );
}
